...
public class VistaCiudad extends javax.swing.JFrame 
{
    ...
    public VistaCiudad() 
    {
        ...
        metodoMouse();
        metodoMouse2();
        this.pintarImagen(jimage, "src/Imagenes/fondo.jpg");
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 146, -1, -1));
        getContentPane().add(txtNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(149, 24, 218, -1));
        getContentPane().add(txtPais, new org.netbeans.lib.awtextra.AbsoluteConstraints(149, 62, 218, -1));
        getContentPane().add(txtDistrito, new org.netbeans.lib.awtextra.AbsoluteConstraints(149, 102, 218, -1));
        getContentPane().add(txtPoblacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(149, 146, 218, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(385, 15, 518, 185));

        jButtonCrear.setText("Crear");
        getContentPane().add(jButtonCrear, new org.netbeans.lib.awtextra.AbsoluteConstraints(54, 186, -1, -1));

        jButtonActualizar.setText("Actualizar");
        getContentPane().add(jButtonActualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(144, 186, -1, -1));

        jButtonEliminar.setText("Eliminar");
        getContentPane().add(jButtonEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(244, 186, -1, -1));
        getContentPane().add(jimage, new org.netbeans.lib.awtextra.AbsoluteConstraints(-3, -4, 930, 240));
